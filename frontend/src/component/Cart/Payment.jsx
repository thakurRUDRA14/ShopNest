...
const Payment = () => {
  ...
  const { loading, error } = useSelector((state) => state.orderData);
          ...
          <motion.div layoutId="order-summary" className="lg:col-span-1">
            <div className="bg-gray-50 p-6 rounded-lg border border-gray-200 sticky top-6">
              ...
              <button
                ...
                disabled={loading}
                className={`w-full flex justify-center align-middle mt-6 bg-indigo-600 text-white py-3 rounded-lg font-medium hover:bg-indigo-700 transition-colors shadow-md ${loading ? "cursor-not-allowed" : ""}`}
              >
                {loading ? (
                  <>
