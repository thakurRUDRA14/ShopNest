...
function Footer() {
  ...
  const quickLinks = ['/', '/products', '/about', '/contact'];
  const customerServices = ['/faq', '/shipping', '/returns', '/privacy'];
  const contactUs = {
    ...
    zip: '110001',
    country: 'India',
    email: "temp.backend@gmail.com",
    phoneNo: "+91 9999888770"
  }
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2">
              {quickLinks.map((path, index) => (
                <motion.li
                  key={index}
                  variants={itemVariants}
                  whileHover={{ x: 2 }}
                >
                  <Link to={path} key={index} className="text-gray-400 hover:text-white">
                    {path === '/' ? 'Home' :
                      path === '/products' ? 'Shop' :
                        path === '/about' ? 'About Us' : 'Contact'}
                  </Link>
                </motion.li>
              ))}
            </ul>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2">
              {customerServices.map((path, index) => (
                <motion.li
                  key={index}
                  variants={itemVariants}
                  whileHover={{ x: 2 }}
                >
                  <Link to={path} key={index} className="text-gray-400 hover:text-white">
                    {path === '/faq' ? 'FAQ' :
                      path === '/shipping' ? 'Shipping Policy' :
                        path === '/returns' ? 'Return Policy' : 'Privacy Policy'}
                  </Link>
                </motion.li>
              ))}
            </ul>
          ...
          <motion.div variants={itemVariants}>
            ...
            <address className="text-gray-400 not-italic">
              ...
              <p>{contactUs.state}, {contactUs.country}</p>
              <p>{contactUs.zip}</p>
              <p>Email: <a href={`mailto:${contactUs.email}`} className="hover:text-white">{contactUs.email}</a></p>
              <p>Phone: <a href={`tel:${contactUs.phoneNo}`} className="hover:text-white">{contactUs.phoneNo}</a></p>
            </address>
          </motion.div>
        </motion.div>
        <motion.div variants={containerVariants} className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <motion.div variants={itemVariants} className="flex space-x-4">
            {/* Instagram */}
            <motion.a
              href="http://instagram.com/thakur._.rudra"
              target="_blank"
              ...
              whileTap="tap"
            >
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="2.5rem" height="2.5rem" viewBox="0 0 100 100">
            ...
            {/* GitHub */}
            <motion.a
              href="https://github.com/thakurRUDRA14"
              target="_blank"
              rel="noopener noreferrer"
              variants={socialIconVariants}
              whileHover="hover"
            ...
            {/* LinkedIn */}
            <motion.a
              href="https://linkedin.com/in/thakurrudra"
              target="_blank"
              rel="noopener noreferrer"
              variants={socialIconVariants}
              whileHover="hover"
